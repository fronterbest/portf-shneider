...
<body>
	<div id="wrap">
		<div id="main" class="clearfix">
			...
			<li><a href="/products-page/">Каталог</a></li>
					...
					<div class="container">
						...
						<?$post = get_post( 105, ARRAY_A);?>
							<div class="col col-xs-12 col-sm-4 col-lg-5 header_part1_email">
								<div id="comp_f89908df0aa4ad23660be3f67f050df4">		<a href="tel:<?=get_post_meta($post["ID"],"email", true)?>">
							...
							<div class="col col-xs-12 col-sm-3 col-md-3 col-lg-3 header_part2_logo">
								<table>
									<tr>
										<td>
											<a href="/">
												<img src="<?php echo esc_url( get_template_directory_uri() ); ?>" class="img img-responsive" alt="logo">
											</a>
										</td>
									</tr>
								</table>								
