...
// Опишем требуемый функционал
    function red_book_cp() {
        ...
        $labels = array(
            'name'                => _x( 'Товары', 'Post Type General Name', 'red_book' ),
            'singular_name'       => _x( 'Товары', 'Post Type Singular Name', 'red_book' ),
            'menu_name'           => __( 'Товары', 'red_book' ),
            'parent_item_colon'   => __( 'Родительский:', 'red_book' ),
            'all_items'           => __( 'Все записи', 'red_book' ),
            'view_item'           => __( 'Просмотреть', 'red_book' ),
            'add_new_item'        => __( 'Добавить новый товар', 'red_book' ),
            'add_new'             => __( 'Добавить новый товар', 'red_book' ),
            'edit_item'           => __( 'Редактировать товар', 'red_book' ),
            'update_item'         => __( 'Обновить товар', 'red_book' ),
            'search_items'        => __( 'Найти товар', 'red_book' ),
